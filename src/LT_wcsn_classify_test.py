...
def classify_test(args):
    ...
    models_folder = pathjoin(save_folder, 'LT_wcsn_models')
    
    os.makedirs(pathjoin(save_folder, 'LT_wcsn_preds'), exist_ok=True)
    preds_folder = pathjoin(save_folder, 'LT_wcsn_preds')
    ...
    all_filtered_genes_file = pathjoin(seq_folder, f'wcsn_filtered_hvgs{HVGs_num}.npy')
