...
def get_parser(parser=None):
    ...
    parser.add_argument('-expr',type=str, default='data/pre_data/scRNAseq_datasets4/Baron_Human.npz')  # 输入文件，这里是npz文件
...
def classify_train(args):
    ...
    # 处理网络文件名称，例如：得到base_filename为HumanNet-GSP
    ...
    os.makedirs(pathjoin(seq_folder, 'wcsn_models'),exist_ok=True)
