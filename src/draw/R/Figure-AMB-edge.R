...
for (folder in top_edges_folders) {
  ...
  output_file <- file.path("../../../../result/Figures/AMB/edge", paste0("AMB_", cell_type, "_edge100_venn.svg"))
...
data <- read.table("../AMB_character_edge_set_indices.tsv", header = TRUE, sep = "\t", fill = TRUE, na.strings ="")
...
svg("../../../Figures/AMB/edge/AMB_threeTypes_edge100_venn.svg", 
    width = 4,   
    height = 4)
